...
MODULE_AUTHOR("Ngwa Sedrick Meh");    ///< The author -- visible when you use modinfo
MODULE_DESCRIPTION("A SCULL Linux Driver");  ///< The description -- see modinfo
...
static int __init scull_driver_init(void){
   ...
   majorNumber = register_chrdev(0, DEVICE_NAME, &file_operations);
   if (majorNumber<0){
